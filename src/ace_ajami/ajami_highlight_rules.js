  ...
  "lika": "paste",
        ...
        this.$rules = {
            "start": [
                ...
                {
                    token: "comment.start", // Multi-line comment start
                    regex: "/\\*",
                    next: "comment"
                },
                {
                    token: "keyword", // Yoruba keywords
                    regex: keywords
                },
                {
                ...
                {
                    token: "string", // Strings with double quotes
                    regex: '".*?"'
                },
                {
                    token: "string", // Strings with single quotes
                    regex: "'.*?'"
                },
                {
                ...
                {
                    token: "paren.lparen", // Parentheses
                    regex: "[\\(]"
                },
                {
                    token: "paren.rparen",
        ...
        // Define keyword groups if needed (optional)
        this.normalizeRules();
    };

    oop.inherits(AjamiHighlightRules, TextHighlightRules);

    exports.AjamiHighlightRules = AjamiHighlightRules;
});
