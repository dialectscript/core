<?php 
include_once('../website/ini.php');
$use_cdn = false;
?>
<!DOCTYPE html>
<html lang="en">
<!-- Complete: Python+JS+Course Menu+PHP+HTML+Ajami+RunOnServerDockerAjax+JS/AJAMI AST+Dynamic Hint+Enhance Task Nav+Regex+ui/ux+Sandbox+jshtmlscript+url+p5.js-->
...
<head>
    ...
    <link rel="apple-touch-startup-image"
        ...
        href="assets/images/apple-launch-640x1136.jpg">
    <link rel="apple-touch-startup-image"
        media="(device-width: 375px) and (device-height: 667px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)"
        href="assets/images/apple-launch-750x1334.jpg">
    <link rel="apple-touch-startup-image"
        media="(device-width: 414px) and (device-height: 736px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)"
        href="assets/images/apple-launch-1242x2208.jpg">
    <link rel="apple-touch-startup-image"
        media="(device-width: 375px) and (device-height: 812px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)"
        href="assets/images/apple-launch-1125x2436.jpg">
    <link rel="apple-touch-startup-image"
        media="(device-width: 768px) and (device-height: 1024px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)"
        href="assets/images/apple-launch-1536x2048.jpg">
    <link rel="apple-touch-startup-image"
        media="(device-width: 834px) and (device-height: 1112px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)"
        href="assets/images/apple-launch-1668x2224.jpg">
    <link rel="apple-touch-startup-image"
        media="(device-width: 1024px) and (device-height: 1366px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)"
        href="assets/images/apple-launch-2048x2732.jpg">
    <meta name="apple-mobile-web-app-status-bar-style" content="default">
    <meta name="apple-mobile-web-app-title" content="">
    <link rel="apple-touch-icon" href="assets/images/apple-touch-icon.jpg">
    <link rel="icon" href="assets/images/apple-touch-icon.jpg">
    <title>
    ...
    <!-- Bootstrap Icons -->
    <link rel="stylesheet" href="vendors/bootstrap-icons-1.9.1/bootstrap-icons.css">
...
pre {
    ...
    <!--link rel="stylesheet" href="codecademy_google.css"-->
    <!--link rel="stylesheet" href="codecademy_medium.css"-->
    <!--link rel="stylesheet" href="codecademy_playcode_gray.css"-->
    <!--link rel="stylesheet" href="codecademy_playcode_light.css"-->

    <!--link rel="stylesheet" href="themes/codecademy_medium_.css"-->

    <link rel="stylesheet" href="themes/codecademy_pro_dark.css">
    <!--link rel="stylesheet" href="codecademy_playcode_dark.css"-->
    ...
    <script src="../src/core/transpiler_console.js" type="module"></script>
</head>
...
<body>
    ...
    <i class="fa-solid fa-layer-group me-2"></i> Courses
                        ...
                        <li><a class="dropdown-item" id="btn-copy-code"><i class="fa-regular fa-copy me-2"></i>Copy
                                Code</a></li>
                        <li>
                        <li>
                            <a class="dropdown-item" id="btn-toggle-sandbox" onclick="toggleSandboxMode()">
                        ...
                        <li><a class="dropdown-item text-danger" id="btn-reset-lesson"><i
                                    class="fa-solid fa-rotate-left me-2"></i>Reset Workspace</a></li>
    ...
    <div class="offcanvas offcanvas-start bg-dark" tabindex="-1" id="lessonToolsSidebar"
     ...
     <a href="courses.php" class="btn btn-outline-light" data-bs-dismiss="offcanvas">
    <i class="fa-solid fa-layer-group me-2"></i> Courses
</a>
    ...
    <!-- Ace Editor -->
    <script src="vendors/ace.js/ace.js"></script>
    <script src="vendors/ace.js/ext-statusbar.js"></script>
    <script src="vendors/ace.js/ext-language_tools.js"></script>

    <?php } ?>


    <script src="../src/ace_ajami/ajami_highlight_rules.js"></script>
    <script src="../src/ace_ajami/ajami_mode.js"></script>
    <script src="../src/ace_ajami/ajami_autocomplete_mappings.js"></script>
    ...
    <script>
        ...
        // Retrieve the single selected lesson metadata synchronously
        const metadata = getLessonMetadataFromStorage();

        // Determine the content of COURSE_LESSONS based on local storage data
        const COURSE_LESSONS = metadata ? [metadata] : [
            // FALLBACK: Use a default lesson if no metadata was passed 
        ...
        */
        ...
        // NEW:
        /*
        const SUPPORTED_LANGS = ['en', 'yo', 'ha', 'ib', 'ar', 'pg'];
        // Use localStorage value, fall back to URL, then fall back to 'ha'
        let currentLanguage = localStorage.getItem('ajami_userLanguage') || getAndCleanLangFromUrl(SUPPORTED_LANGS) || 'ha'; 
        let currentLanguageFromUrl = currentLanguage; // Keep this variable for legacy dependencies if needed
        */
        if(currentLanguageFromUrl ==''){
            currentLanguageFromUrl = localStorage.getItem('ajami_userLanguage') || ''; 
        }
        ...
        // --- Helper Function ---
function getLessonMetadataFromStorage() {
    const json = localStorage.getItem('ajami_selectedLessonMetadata');
    // Clear storage immediately after reading, to prevent stale data
    localStorage.removeItem('ajami_selectedLessonMetadata'); 
    return json ? JSON.parse(json) : null;
        ...
        function initializeAceEditor(elementId, language) {
            ...
            setEditorMode(language, language);
